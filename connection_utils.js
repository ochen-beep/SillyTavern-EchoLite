                ...
                try {
                    ...
                    const response = await ctx.ConnectionManagerRequestService.sendRequest(
                        ...
                        maxTokens,
                        {
                            ...
                            signal:          signal || null,
                            extractData:     true,
                            includePreset:   false, // не применять пресет ST — у каждого юзера он разный и ломает наш systemPrompt
                            includeInstruct: false, // не применять instruct-шаблон — мы строим сообщения сами в виде [{role,content}]
                        }
                    );
